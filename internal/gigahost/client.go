...
// Package gigahost is a minimal Gigahost API client for the autoscaler,
// mirroring terraform-provider-gigahost's internal client.
package gigahost
...
// flex* types absorb scalars the API encodes as JSON strings.
type flexBool bool
